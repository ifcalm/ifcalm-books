#!/usr/bin/env python3
"""Generate She Dacheng Lun commentaries from CBETA stable juan API."""
...
COLLECTIONS = {
    "she-da-cheng-lun-shi-zhendi": {
        "work": "T1595",
        "display_title": "摄大乘论释 真谛译",
        "tag": "摄大乘论释",
        "slug": "she-da-cheng-lun-shi-zhendi",
        "target": "she-da-cheng-lun-shi-zhendi",
        "total_juan": 15,
        "weight": 50,
        "summary": "摄大乘论释十五卷，真谛译。",
        "expected_category": "瑜伽部類",
        "removable_title_patterns": [r"^攝大乘論釋卷第?[零一二三四五六七八九十百]+$"],
        "removable_bylines": {"世親菩薩釋", "陳天竺三藏真諦譯"},
    },
    "she-da-cheng-lun-shi-lun": {
        "work": "T1596",
        "display_title": "摄大乘论释论",
        "tag": "摄大乘论释论",
        "slug": "she-da-cheng-lun-shi-lun",
        "target": "she-da-cheng-lun-shi-lun",
        "total_juan": 10,
        "weight": 60,
        "summary": "摄大乘论释论十卷。",
        "expected_category": "瑜伽部類",
        "removable_title_patterns": [r"^攝大乘論釋論卷第?[零一二三四五六七八九十百]+$"],
        "removable_bylines": {"世親菩薩造", "隋天竺三藏笈多共行矩等譯"},
    },
    "she-da-cheng-lun-shi-xuanzang": {
        "work": "T1597",
        "display_title": "摄大乘论释 玄奘译",
        "tag": "摄大乘论释",
        "slug": "she-da-cheng-lun-shi-xuanzang",
        "target": "she-da-cheng-lun-shi-xuanzang",
        "total_juan": 10,
        "weight": 70,
        "summary": "摄大乘论释十卷，玄奘译。",
        "expected_category": "瑜伽部類",
        "removable_title_patterns": [r"^攝大乘論釋卷第?[零一二三四五六七八九十百]+$"],
        "removable_bylines": {"世親菩薩造", "三藏法師玄奘奉詔譯"},
    },
}
